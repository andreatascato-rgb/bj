...
export function StepRail({
  ...
  return (
    <div
      ...
      role="list"
      aria-label={`Passo ${current + 1} di ${steps.length}`}
    >
      {steps.map((label, i) => {
        ...
        return (
          <div
            ...
            className={`flex min-h-11 items-center justify-center rounded-full px-2 text-[11px] font-semibold tracking-wide transition ${
              active
